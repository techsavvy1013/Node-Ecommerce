...
import GetOptions from './Category.option';
...
export default function Category() {
  ...
  var categorySelectOptions = GetOptions();
  ...
  const Icon = ({ name }) => {
    ...
    if(!!TagName){
      ...
      var url = `assets/icons/${name}`;
      if(name === '' || name === undefined){
        console.log(url);
        return (<p>Can't find the image.</p>);
      }else
      {
        const GetImage = lazy(() => import(`assets/icons/${name}`));
