...
import {USER_AVATAR_URL} from '../../../base_url';
...
const Topbar = ({ refs }: any) => {
  var loginedId = localStorage.getItem('userId');
  var UserImageUrl = `${USER_AVATAR_URL}?loginedId=${loginedId}`; 
  ...
  return (
    <TopbarWrapper ref={refs}>
      ...
      <TopbarRightSide>
        ...
        >
          <ProfileImg>
            <Image src={UserImageUrl} alt="user" />
          </ProfileImg>
        </Popover>
      </TopbarRightSide>
    </TopbarWrapper>
