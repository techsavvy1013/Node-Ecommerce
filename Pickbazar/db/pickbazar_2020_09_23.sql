...
CREATE TABLE `cc_transactions`  (
  ...
  `delivery_address` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `cc_transactions` VALUES (1, NULL, 1, '2020-09-22 08:18:52', '', '', 'Moscow', 100, 10, 20, 1, NULL, 'on cash', NULL, 0, '2020-09-22 08:19:20', '2020-09-22 08:19:23');
...
-- ----------------------------
INSERT INTO `payment_mothod` VALUES (1, 'paypal');
...
CREATE TABLE `sales_orders`  (
  ...
  `delivery_address` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `contact_number` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `sales_orders` VALUES (1, '0000-00-00', 1, '1', 2, 'Moscow', '715-371-3507', 100, 'hello test', '2020-09-22 08:18:21', '2020-09-22 08:18:23');
...
CREATE TABLE `users`  (
  ...
  `contact_id` int(0) NULL DEFAULT NULL,
  `contact_number1` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `contact_number2` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `payment` tinyint(0) NULL DEFAULT NULL,
  `active` tinyint(1) NULL DEFAULT 1,
  `inserted_at` timestamp(0) NOT NULL,
  `updated_at` timestamp(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'admin', '', 'Alex', 'Hrabryh', 'https://randomuser.me/api/portraits/men/80.jpg', NULL, NULL, NULL, NULL, 1, '2020-09-01 17:46:57', '2020-09-01 17:47:18');
INSERT INTO `users` VALUES (2, 'test@test.com', '', 'Alex', 'Tester', 'https://randomuser.me/api/portraits/men/35.jpg', NULL, '320-692-5287', '937-667-7660', 1, 1, '2020-09-22 09:17:06', '2020-09-22 09:17:03');
